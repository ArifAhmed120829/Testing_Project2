...
public class Teacher_Signup extends AppCompatActivity {
    ...
    private CollectionReference firestore_collectionreference = firestore_database.collection("teachers");
        ...
        sign_up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!TextUtils.isEmpty(email.getText().toString()) && !TextUtils.isEmpty(password.getText().toString())
                    ...
                    Toast.makeText(Teacher_Signup.this, "Registered Successfully", Toast.LENGTH_SHORT).show();

                }


                else{
                    Toast.makeText(Teacher_Signup.this, "Email,Username or Password can't be empty", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                                ...
                                documentReference.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                    ...
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        if(Objects.requireNonNull(task.getResult()).exists()){
                                            ...
                                            Intent i = new Intent(Teacher_Signup.this,Teacher.class);
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(Teacher_Signup.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        });
